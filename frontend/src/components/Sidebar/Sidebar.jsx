...
const Sidebar = () => {
  return (
    <div className='container  d-flex flex-nowrap mx-2 my-2' style={{"maxHeight":100+"vh"}}>
        <div className="d-flex bg-success bg-info flex-column flex-shrink-0 bg-light" style={{"width": 4.5+"rem"}}>
    ...
    <ul className="nav nav-pills nav-flush flex-column mb-auto text-center">
      ...
      <li>
        <a href="#" className="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right">
