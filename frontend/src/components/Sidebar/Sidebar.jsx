...
const Sidebar = () => {
  return (
    // <div className='container  d-flex flex-nowrap mx-2 my-2' style={{"maxHeight":100+"vh"}}>
        <div className="border-dark mx-2 border rounded-2 d-flex bg-success bg-info flex-column flex-shrink-0  het bg-light " style={{"width": 4.5+"rem" }} >
    ...
    <ul className="nav nav-pills nav-flush flex-column mb-auto text-center">
      ...
      <li>
        ...
        <Link to="/contect" className="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right"><i class="fa-solid fa-address-book"></i></Link>
        {/* <a href="#" >
