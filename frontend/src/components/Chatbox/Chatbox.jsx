        ...
        <div class="card">
          ...
          <div class="card-body" data-mdb-perfect-scrollbar="true" style={{position:" relative",height:"400px"}}>
            ...
            <div class="d-flex flex-row justify-content-start">
              <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava5-bg.webp"
                alt="avatar 1" style={imgstyle}/>
              <div>
                <p class="small p-2 ms-3 mb-3 rounded-3" style={{"backgroundColor": "#f5f6f7"}}>For what reason
                  would it
            ...
            <div class="d-flex flex-row justify-content-start">
              <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava5-bg.webp"
                alt="avatar 1" style={imgstyle}/>
              <div>
                <p class="small p-2 ms-3 mb-3 rounded-3" style={{backgroundColor: "#f5f6f7"}}>Lorem ipsum dolor
                  sit amet
          ...
          <div class="card-footer text-muted d-flex justify-content-start align-items-center p-3">
            <div class="input-group mb-0">
              ...
              <button class="btn btn-warning" type="button" id="button-addon2" style={{paddingTop: ".55rem"}}>
                Button
              </button>
            </div>
          </div>
